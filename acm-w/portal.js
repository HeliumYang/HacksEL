...
function generateAttendance(email, fName, lName) {
  infoCards.innerHTML = "<div id='attendance' class = 'infoCard'><b>ACM-W Girls.Code() Attendance:</b><br><br><table id='attendanceTable'><div id='loadingicon'><img src='Loading_icon.gif'></div></table><br>This updates automatically! If you checked-in to a meeting or filled out a reflection and it does not show up here, please contact <a href='mailto:ugagirls.code@gmail.com'>ugagirls.code@gmail.com</a>.</div></div>" +
...
'<br><br>For a portion of this requirement, students must attend at least 3-hours of student organization activities through the UGA chapter of Association for Computing Machinery, ACM-W Girls.Code(), or Society for Cyber Security. There is a maximum additional 9-hours of involvement that can also be fulfilled by student organization activities, adding up to a total of 12-hours in campus involvement. You can either choose to fulfill all 12 of your involvement hours through the same student organization, or complete your requirement by completing a combination of different activities through the various student organizations.' +
'<br><br>For any event to count towards your UGAHacks Experiential Learning requirement, you must fill out a <b>100-word</b> reflection within <b>1 week</b> of the event. You can submit your reflection and track your progress for ACM-W related hours through your membership portal. You <b>DO NOT</b> need to be a paying member for your attendance to count towards UGAHacks EL.' +
