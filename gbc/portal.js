...
function generateAttendance(email, fName, lName) {
  infoCards.innerHTML = "<div id='attendance' class = 'infoCard'><b>Game Builders Club Attendance:</b><br><br><table id='attendanceTable'><div text-allign:center id='loadingicon'>Please wait... If your attendance portal does not refresh within 1 minute, please reach out to <a href='mailto:hacksel@heliumyang.com'>hacksel@heliumyang.com</a><br><img src='Loading_icon.gif'></div></table><br>This updates automatically! If you checked-in to a meeting or filled out a reflection and it does not show up here, please contact <a href='mailto:PLACEHOLDER@gmail.com'>PLACEHOLDER@gmail.com</a>.</div></div>" +
"<div id='elInfo' class = 'infoCard'><b>About UGAHacks Experiential Learning</b> [<a href='javascript:showELInfo();'>show</a>]</div>"
  httpGetAsync("https://script.google.com/macros/s/AKfycby4j7lcrRVC1moY16zGTVIKkFAzkKNvuZxh-nWqgxox_jJGzmWYzgh-K44rAQl5106r/exec?myid=" + email.split("@")[0], function(data){
...
'<br><br>For a portion of this requirement, students must attend at least 3-hours of student organization activities through the UGA chapter of Association for Computing Machinery, ACM-W Girls.Code(), Society for Cyber Security, the Hack Pack, or Game Builders Club. There is an additional maximum 9-hours of involvement that can also be fulfilled by student organization activities, adding up to a total of 12-hours in campus involvement. You can either choose to fulfill all 12 of your involvement hours through the same student organization, or complete your requirement by completing a combination of different activities through the various student organizations.' +
'<br><br>For any event to count towards your UGAHacks Experiential Learning requirement, you must fill out a <b>100-word</b> reflection within <b>1 week</b> of the event. You can submit your reflection and track your progress for Hack Pack-related hours through your membership portal. You <b>DO NOT</b> need to be a paying member for your attendance to count towards UGAHacks EL.' +
