...
function generateAttendance(email, fName, lName) {
  infoCards.innerHTML = "<div id='attendance' class = 'infoCard'><b>The Hack Pack Attendance:</b><br><br><table id='attendanceTable'><div text-allign:center id='loadingicon'>Please wait... If your attendance portal does not refresh within 1 minute, please reach out to <a href='mailto:hacksel@heliumyang.com'>hacksel@heliumyang.com</a><br><img src='Loading_icon.gif'></div></table><br>This updates automatically! If you checked-in to a meeting or filled out a reflection and it does not show up here, please contact <a href='mailto:thehackpack.uga@gmail.com'>thehackpack.uga@gmail.com</a>.</div></div>" +
"<div id='elInfo' class = 'infoCard'><b>About UGAHacks Experiential Learning</b> [<a href='javascript:showELInfo();'>show</a>]</div>"
  httpGetAsync("https://script.google.com/macros/s/AKfycbz9hZen_J2UvD8aFiswg2gNgpVTSySif8MGHDRoabKyRNDS_0TMBkb35yAgzuSh81Xc9A/exec?myid=" + email.split("@")[0], function(data){
...
'<br><br>For a portion of this requirement, students must attend at least 3-hours of student organization activities through the UGA chapter of Association for Computing Machinery, ACM-W Girls.Code(), Society for Cyber Security, or the Hack Pack. There is an additional maximum 9-hours of involvement that can also be fulfilled by student organization activities, adding up to a total of 12-hours in campus involvement. You can either choose to fulfill all 12 of your involvement hours through the same student organization, or complete your requirement by completing a combination of different activities through the various student organizations.' +
